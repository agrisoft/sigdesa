    ...
    var self = {
        ...
        setupToolbarBaseMap: function() {
            _baseLayers = {
                ...
                CSRT_Jawa: new ol.layer.Tile({
                    visible: true,
                    preload: Infinity,
                    source: new ol.source.XYZ({
                        url: 'http://portal.ina-sdi.or.id/arcgis/rest/services/CITRASATELIT/JawaBaliNusra_2015_rev/MapServer/tile/{z}/{y}/{x}'
                    })
                }),
            ...
            self.addBaseLayer({
                id: 'OSM_Std',
                title: 'OSM Standard',
                thumb: _baseURL + 'static/image/base-osm-road.png',
            ...
            self.addBaseLayer({
                ...
                thumb: _baseURL + 'static/image/base-rbi.png',
                layer: _baseLayers.RBI_Indonesia
            });
            self.addBaseLayer({
                id: 'EsriWI',
                title: 'ESRI World Imagery',
                thumb: _baseURL + 'static/image/base-bing-aerial.png',
                layer: _baseLayers.EsriWI
            });
            self.addBaseLayer({
                id: 'CSRT_Jawa',
                title: 'Citra Satelit Resolusi Tinggi (Jawa)',
                thumb: _baseURL + 'static/image/base-bing-aerial.png',
                layer: _baseLayers.CSRT_Jawa
            });
